...
To receive testnet REACT, send SepETH to the Reactive faucet contract on Ethereum Sepolia: `0x9b9BB25f1A81078C544C829c5EB7822d747Cf434`. An equivalent amount of REACT will be sent to your address, up to a 0.1 SepETH limit, assuming the faucet has funds. You can use MetaMask or any compatible wallet for the transfer.
