...
A subscription tells the network which logs should reach your contract. Each one is a set of criteria passed to `SYSTEM.subscribe()`, and both methods take the same six arguments:
