...
sidebar_position: 8
description: Reference for the Reactive's library — abstract contracts and interfaces for building reactive contracts.
...
function detectVm() internal {
    ...
    assembly { size := extcodesize(0x8888888888888888888888888888888888888888) }
    vm = size == 0;
}
```
