...
[AbstractCallback](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/base/AbstractCallback.sol) provides callback authorization for destination-side contracts. The contract initializes `_CALLBACK_SENDER`, which is the reactive contract authorized to send callbacks.
...
[AbstractPayer](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/base/AbstractPayer.sol) provides payment and debt-settlement functionality for reactive contracts. The contract defines: `_SERVICE_PROVIDER`, which is the system contract or callback proxy authorized to request payments.
...
[AbstractReactive](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/base/AbstractReactive.sol) is the base contract for reactive contracts. It provides access to the Reactive's system contract and subscription service.
...
[IPayable](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/interfaces/IPayable.sol) defines payment and debt-query functionality for reactive contracts. It is the common interface for both the system contract and the callback proxy.
...
[IPayer](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/interfaces/IPayer.sol) defines the interface for contracts that need to pay for system contract or proxy services.
...
[IReactive](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/interfaces/IReactive.sol) defines the main interface for reactive contracts. It provides event notifications and the execution entry point.
...
[ISubscriptionService](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/interfaces/ISubscriptionService.sol) defines functions for managing event subscriptions. Reactive contracts use it to subscribe to or unsubscribe from event logs.
...
[ISystemContract](https://github.com/Reactive-Network/reactive-lib-omni/blob/master/src/interfaces/ISystemContract.sol) combines the functionality of `IPayable` and `ISubscriptionService`, and provides callback request methods. It represents the Reactive's system contract interface.
